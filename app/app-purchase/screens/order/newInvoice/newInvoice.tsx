...
export const NewInvoice: FC = observer(function NewInvoice(props) {
  ...
  useEffect(() => {
    console.log(
      "first",
      moment(markedDatesS === "" ? new Date() : markedDatesS).format(
        "DD/MM/YYYY"
      )
    );
  });
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <Text
              ...
              style={{ fontSize: fontSize.size16, fontWeight: "600" }}
            />
              ...
              <Controller
                ...
                render={({ field: { onChange, value, onBlur } }) => (
                  <TextField
                    ...
                    value={value}
                    valueInput={
                      minDateS ? moment(minDateS).format("DD/MM/YYYY") : ""
                    }
                    pressRightIcon={() => {
                      toggleModalDate(), setChoiseCalendar(1);
                    }}
                    onBlur={onBlur}
            ...
            <Controller
              ...
              render={({ field: { onChange, value, onBlur } }) => (
                <TextField
                  ...
                  RightIcon={Svgs.icon_CalenderBlank}
                  pressRightIcon={() => {
                    toggleModalDateEnd(), setChoiseCalendar(2);
                  }}
            ...
            <View
              ...
              <ProductAttribute
                ...
                value={formatVND(
                  formatCurrency(commasToDots(calculateTotalUnTaxPrice()))
                )}
              />
              {groupTaxValues(data.computeTaxInfo?.taxLines).map(
                (item: any) => (
                  <ProductAttribute
                    label={item.taxName}
