...
export const VoucherDetail: FC<StackScreenProps<NavigatorParamList,"voucherDetail">> = observer (
            ...
            <View style={{ flex: 1 }}>
                ...
                >
                    <View style={{ marginTop: scaleHeight(30), marginBottom: scaleHeight(15) }}>
                        <Text style={{ textAlign: 'center', fontFamily: "Inter-Bold", fontSize: scaleWidth(16) }} tx="ImprotGoodsBook.importCoupon" />
