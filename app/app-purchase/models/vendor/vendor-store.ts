...
export interface VendorStoreSnapshotOut
  extends SnapshotOut<typeof VendorStoreModel> {}
export interface VendorStoreSnapshotIn
  extends SnapshotIn<typeof VendorStoreModel> {}
export const createVendorStoreDefaultModel = () =>
  types.optional(VendorStoreModel, {});
