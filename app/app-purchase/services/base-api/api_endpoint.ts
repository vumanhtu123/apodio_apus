export const ApiEndpoint = {
  ...
  HISTORY: "/history",
  LIST_CATEGORY: "/api/v1/internal/mobile-product-category/list",
  DETAIL_UNIT_GROUP: "/api/v1/mobile-unit-group",
  LIST_UNIT: "/api/v1/unit/list",
  LIST_UNIT_GROUP: "/api/v1/mobile-unit-group/list",
  DELETE_CATEGORY: "/api/v1/internal/mobile-product-category",
  CREATE_CATEGORY: "/api/v1/internal/product-category",
  UPDATE_CATEGORY: "/api/v1/internal/product-category",
  CREATE_UNIT: "/api/v1/unit",
  CREATE_UNIT_GROUP: "/api/v1/mobile-unit-group",
  LIST_TAG_PRODUCT: "/api/v1/internal/tag/list",
  ...
  GET_LIST_PRODUCT: "/api/v1/internal/mobile-product-template/list",
  ADD_PRODUCT: "/api/v1/internal/mobile-product-template",
  EDIT_CLASSIFY: "/api/v1/internal/product-template/product",
  DELETE_CLASSIFY: "/api/v1/internal/mobile-product-template/variant",
  PUT_MOVE_CATEGORY: "/api/v3/internal/product-category/move-sequence",
  GET_PRODUCT_DETAIL: "/api/v1/internal/mobile-product-template",
  GET_CLASSIFY_DETAIL: "/api/v1/internal/mobile-product-template/variant",
  GET_LIST_VENDOR: "/api/v1/vendor/partners/list",
  UPLOAD_IMAGES: "/api/v1/file-upload",
  DELETE_CHECK: "/api/v1/internal/product-template/delete-check",
