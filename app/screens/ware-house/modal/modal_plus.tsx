...
import { View, Modal, StyleSheet, TextInput, TouchableOpacity, Image } from 'react-native';
...
const Modal_Plus: FC<ModalCreateGroup> = ({ isVisible, setIsVisible }) => {
    ...
    return (
        ...
        >
            <View style={Styles.container}>
                <View style={{ alignSelf: 'flex-end', marginBottom: 10, marginRight: 6 }}>
