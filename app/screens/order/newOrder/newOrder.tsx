...
import { Alert, Dimensions, FlatList, Image, KeyboardAvoidingView, Linking, Platform, ScrollView, TextInput, TouchableOpacity, View } from "react-native";
...
import ImagesGroup from "../../product/componet/imageGroup";
...
export const NewOrder: FC = observer(
    function NewOrder(props) {
        ...
        const heightScroll = Dimensions.get("window").height - scaleHeight(120) - scaleHeight(52) - paddingTop
            ...
            <View style={{ backgroundColor: colors.palette.aliceBlue }}>
                ...
                <KeyboardAvoidingView
                    ...
                    <ScrollView
                        ...
                        bounces={false}
                        style={[styles.viewScrollVertical, {
                            height:
                                isDeposit === true ? heightScroll - scaleHeight(64) : heightScroll
                        }]}>
                        <View style={styles.viewSupplier}>
                            <Text tx={'order.supplier'} style={[styles.textTotal, {
                            ...
                            <Text text="Cong ty TNHH Mat Troi Hong"
                                style={[styles.textContent, { marginVertical: scaleHeight(margin.margin_8) }]} />
                            <Text text="Nguyen Ngoc Anh" style={styles.textContent} />
                        </View>
                        <View style={styles.viewAddress}>
                            <Text tx={'order.deliveryAddress'} style={[styles.textTotal, {
                                paddingBottom: scaleHeight(padding.padding_16)
                            }]} />
                            <View style={styles.viewAddressChoice}>
                                <TouchableOpacity onPress={() => setAddressChoice(!addressChoice)}
                                    style={styles.viewBorderCircleAddressChoice}>
                                    <View style={[styles.viewCircleAddressChoice, {
                                        backgroundColor: addressChoice === false ? colors.palette.navyBlue : colors.palette.neutral100,
                                    }]}></View>
                                </TouchableOpacity>
                                <Text tx={'order.warehouseAddress'} style={styles.textAddressChoice} />
                            </View>
                            <View style={styles.viewAddressChoice}>
                                <TouchableOpacity onPress={() => setAddressChoice(!addressChoice)}
                                    style={styles.viewBorderCircleAddressChoice}>
                                    <View style={[styles.viewCircleAddressChoice, {
                                        backgroundColor: addressChoice === true ? colors.palette.navyBlue : colors.palette.neutral100,
                                    }]}></View>
                                </TouchableOpacity>
                                <Text tx={'order.specificAddress'} style={styles.textAddressChoice} />
                            </View>
                            <View>
                                <View style={{ flexDirection: 'row' }}>

                                    <Text text="Cong ty TNHH Mat Troi Hong" style={[styles.textContent, { flex: 1 }]} />
                                    <Images.icon_caretRight2 />
                                </View>
                                <Text text="02466876656"
                                    style={[styles.textContent, { marginVertical: scaleHeight(margin.margin_8) }]} />
                                <Text text="85 Hang Bai, Hoan Kiem, HN" style={styles.textContent} />
                            </View>
                        </View>
                        <View style={styles.viewNameCompany}>
                            <AutoHeightImage height={32} width={32}
                                style={{ borderRadius: 16, marginRight: scaleWidth(margin.margin_8) }}
                                source={{ uri: 'https://th.bing.com/th/id/OIG.ey_KYrwhZnirAkSgDhmg' }}
                                fallbackSource={Images.avatarError} />
                            <Text text="Cong ty TNHH mot thanh vien Apodio"
                        ...
                        <View style={styles.viewListProduct} >
                            <Button
                                ...
                                <Images.icon_add />
                                <Text tx={'order.addProduct'} style={styles.textButtonListProduct} />
                            </Button>
                            <FlatList
                                data={arrProduct}
                                scrollEnabled={false}
                                ...
                                renderItem={({ item, index }) => {
                                    return (
                                        <View>
                                            ...
                                            />
                                            {index !== arrProduct.length - 1 ? <View style={{ height: scaleHeight(1), backgroundColor: colors.palette.ghostWhite }} /> : null}
                                        </View>
                                    )
                                }}
                            />
                        ...
                        <View style={styles.viewPaymentMethod}>
                            <InputSelect
                                ...
                                arrData={arrPayment}
                                onPressChoice={(item) => { setPayment(item) }}
                        ...
                        <View style={styles.viewVoucher}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={[styles.textVoucher, { flex: 1 }]}>
                                    {translate('order.total') + ' ' + arrProduct.length + ' ' +
                                        translate('order.product')}</Text>
                                <Text style={[styles.textVoucher, { color: colors.palette.nero }]}>84000000</Text>
                            </View>
                            <TouchableOpacity onPress={() => navigation.navigate('promotion' as any)}
                                style={{ flexDirection: 'row', marginTop: scaleHeight(margin.margin_20) }}>
                        ...
                        {note === true ?
                            <View style={styles.viewNote}>
                                ...
                                {imagesNote === '' ? <TouchableOpacity onPress={() => setModalImage(true)}>
                                    <Images.icon_image />
                                </TouchableOpacity> :
                                    <TouchableOpacity onPress={() => setModalImage(true)}>
                                        <Image source={{ uri: imagesNote }} height={scaleHeight(48)} width={scaleWidth(48)}
                                            resizeMode='cover'
                                            style={{ borderRadius: 8 }} />
                                    </TouchableOpacity>}
                                <TouchableOpacity onPress={() => setNote(false)} style={{ position: 'absolute', right: 6, top: 6 }}>
                                    <Images.icon_deleteDolphin />
                                </TouchableOpacity>
                            </View>
                            : null}
                        {desiredDate === true ? <View style={{
                            flexDirection: 'row',
                            ...
                            <TouchableOpacity onPress={() => setIsSortByDate(true)}
                                style={{
                                    flexDirection: 'row', alignItems: 'center',
                                    marginLeft: scaleWidth(margin.margin_8)
                                }}>
                                <Images.icon_calendar />
                                <Text style={[styles.textDate, { marginHorizontal: scaleWidth(margin.margin_4,) }]}>
                                    {translate('order.desiredDate') + ': ' + moment(markedDatesS === "" ? new Date() : markedDatesS).format("MMMM DD, YYYY")}
                                </Text>
                                <Images.icon_caretDownBlue />
                            </TouchableOpacity>
                        </View> : null}
                        <Text tx={'order.moreInformation'} style={[styles.textTotal,
                        {
                        ...
                        <View style={styles.viewMoreInformation}>
                            <Images.icon_gear style={{ marginRight: scaleWidth(margin.margin_4) }} />
                            {note === false || isDeposit === false || desiredDate === false ?
                                <ScrollView
                                    horizontal={true}
                                    showsHorizontalScrollIndicator={false}
                                >
                                    {note === false ? <Button tx={'order.note'}
                                        onPress={() => setNote(true)}
                                        style={styles.buttonFeature}
                                        textStyle={[styles.textVoucher, { color: colors.palette.navyBlue }]} /> : null}
                                    {isDeposit === false ? <Button tx={'order.deposit'}
                                        onPress={() => setIsDeposit(true)}
                                        style={styles.buttonFeature}
                                        textStyle={[styles.textVoucher, { color: colors.palette.navyBlue }]} /> : null}
                                    {desiredDate === false ? <Button tx={'order.desiredDate'}
                                        onPress={() => setDesiredDate(true)}
                                        style={styles.buttonFeature}
                                        textStyle={[styles.textVoucher, { color: colors.palette.navyBlue }]} /> : null}
                                </ScrollView> : <Text tx={'order.noMoreInformation'} style={styles.textVoucher} />}
                        </View>
                    </ScrollView>
                </KeyboardAvoidingView>
                <View style={[styles.viewButtonOrder,
                {
                    top: isDeposit === true ? Dimensions.get("window").height - scaleHeight(184) :
                        Dimensions.get("window").height - scaleHeight(120),
                }]}>
                    <View style={{
                        flexDirection: 'row', paddingTop: scaleHeight(padding.padding_20),
                        paddingBottom: scaleHeight(padding.padding_12)
                    }}>
                        <Text tx={'order.total'} style={[styles.textTotal, { flex: 1 }]} />
                        <Text style={isDeposit === true ? styles.textTotal : styles.textCost} >84000000000</Text>
                    </View>
                    {isDeposit === true ? <View style={{
                        flexDirection: 'row', paddingBottom: scaleHeight(padding.padding_12)
                    }}>
                        <Text tx={'order.prepayment'} style={[styles.textTotal, { flex: 1 }]} />
                        <Text style={styles.textTotal} >{deposit}</Text>
                        <TouchableOpacity>
                            <Images.icon_edit style={{ marginLeft: scaleWidth(margin.margin_6) }} />
                        </TouchableOpacity>
                    </View> : null}
                    {isDeposit === true ? <View style={{
                        flexDirection: 'row', paddingBottom: scaleHeight(padding.padding_12)
                    }}>
                        <Text tx={'order.stillInDebt'} style={[styles.textTotal, { flex: 1 }]} />
                        <Text style={[styles.textCost, { color: colors.palette.radicalRed }]} >84000000000</Text>
                    </View> : null}
                    <Button onPress={() => {}}
                        tx={'order.order'}
