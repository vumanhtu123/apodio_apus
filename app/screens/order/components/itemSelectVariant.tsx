                ...
                <View style={{ width: '100%' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: scaleHeight(3) }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', width: '40%' }}>
                            ...
                            <Text style={[styles.text400Nero12, {color: colors.palette.radicalRed, fontStyle: 'italic'}]} text={item.price} />
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={styles.viewAmount}>
                            ...
                            <TouchableOpacity disabled={item.amount === item.quantityInventory || item.amount === Math.floor(item.minQuantity / item.conversionRate) ? true : false} onPress={() => handlePlusPrice(item)}
                    ...
                    {item.isSelect === true ?
                        <View style={{ flexDirection: 'row', alignItems: 'center', height: scaleHeight(14.52), marginTop: scaleHeight(3) }}>
                            {item.price !== undefined && check === false ? <View style={{ flexDirection: 'row', alignItems: 'center', width: '40%' }}>
                                ...
                                <Text style={styles.textPriceInput} text={item.price} />
                                <TouchableOpacity onPress={() => {
                                    setValue(`price.${item.id}.price`, item.price.toString())
                                    setCheck(true)
                                }}>
                                    <Images.icon_edit />
                                </TouchableOpacity>
