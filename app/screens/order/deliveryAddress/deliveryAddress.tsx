                ...
                <View style={[styles.viewModal, { maxHeight: '85%' }]}>
                    <View>
                        <FlatList
                            ...
                            renderItem={(item) => {
                                return (
                                    <TouchableOpacity onPress={() => handlePress(item.item)} key={item.item.id}>
                                                ...
                                                <View style={{
                                                    ...
                                                    <View style={{ flex: 1 }}>
                                                        <View style={{ flexDirection: 'row' }}>
                                                            ...
                                                            <Text text={item.item.phoneNumber} style={styles.textMoney2} />
                                                            <TouchableOpacity
                                                        ...
                                                        <View style={{
                                                            ...
                                                            <Text style={styles.textListProduct} >
                                                                ...
                                                                <Text style={styles.textMoney2} >{item.item.city.name}</Text>
                                                                <Text style={styles.textMoney2} text=', ' />
                                                                <Text style={styles.textMoney2} >{item.item.district.name}</Text>
                                                                <Text style={styles.textMoney2} text=', ' />
                                                                <Text style={styles.textMoney2} >{item.item.ward.name}</Text>
                                                                <Text style={styles.textMoney2} text=', ' />
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    {item.item.addressType === 'DELIVERY_ADDRESS' ?
                                                        <View style={styles.viewBorder}>
                                                            <Text tx={'order.deliveryAddress'} style={styles.textDolphin400} />
                                                        </View>
                                                        : item.item.addressType === 'RECEIPT_ADDRESS' ?
                                                            <View style={styles.viewBorder}>
                                                                <Text tx={'order.receiptAddress'} style={styles.textDolphin400} />
                                                            </View>
                                                            : item.item.addressType === 'INVOICE_ADDRESS' ?
                                                                <View style={styles.viewBorder}>
                                                                    <Text tx={"order.invoiceAddress"} style={styles.textDolphin400} />
                                                                </View>
                                                                : item.item.addressType === 'OTHER_ADDRESS' ?
                                                                    <View style={styles.viewBorder}>
                                                                        <Text tx={'order.otherAddress'} style={styles.textDolphin400} />
                                                                    </View>
                                                                    : item.item.addressType === 'PERSONAL_ADDRESS' ?
                                                                        <View style={styles.viewBorder}>
                                                                            <Text tx={'order.personalAddress'} style={styles.textDolphin400} />
                                                                        </View>
                                                                        : <View style={styles.viewBorder}>
                                                                            <Text tx={'order.contact'} style={styles.textDolphin400} />
                                                                        </View>}
                                                    {item.item.isDefault === true ? <View >
