...
import { View, Text as TextRN, TouchableOpacity, Image, ScrollView } from "react-native"
        ...
        >
            <View style={[styles.modalView,]}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerTitle} tx="NCCScreen.addContactPerson"></Text>
                ...
                />
                <ScrollView style={{ height: scaleHeight(570) }} showsVerticalScrollIndicator={false}>
                    <View
                        style={{
                            flexDirection: 'row',
                        ...
                        <View style={{}}>
                            <View style={{ flex: 1 }} >
                                ...
                                <Image
                                    ...
                                    source={require("../../../../assets/Images/img_BrickTest.png")}
                                    style={{ width: scaleWidth(107), height: scaleHeight(76), borderRadius: 8, zIndex: 1 }}
                                >
                                </Image>
                            </View>
