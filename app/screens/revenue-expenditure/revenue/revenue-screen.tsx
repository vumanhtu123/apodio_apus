...
export const RevenueScreen: FC<StackScreenProps<NavigatorParamList, 'addRevenueScreen'>> = observer(
    ...
    function revenueScreen(props) {
        ...
        const { control, getValues, setValue, formState: { errors } } = useForm<FromValue>()
        ...
        return (
            <View style={Styles.Root}>
                ...
                >
                    ...
                    <Text style={{ color: colors.palette.navyBlue, marginHorizontal: scaleWidth(4) }}>Thứ 5: </Text>
