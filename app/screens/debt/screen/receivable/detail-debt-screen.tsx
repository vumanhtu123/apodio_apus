...
import { ModalPayReceivable } from "../../component/modalPayReceivable2";
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={Styles.styleBody}>
          ...
          <View style={[Styles.flexRow, { alignItems: "center" }]}>
            <View style={{}}>
              ...
              <Text
                ...
                {formatVND(formatCurrency(commasToDots(100000)))}
              </Text>
            </View>
        ...
        <View
          style={[
            Styles.flexRow,
            { marginHorizontal: scaleWidth(15), marginTop: scaleWidth(20) },
          ]}>
          <View style={[Styles.flexRow]}>
      ...
      <FlatList
        ...
        ListFooterComponent={() => {
          // console.log('doan');
          return (
            isLoadingMore && <ActivityIndicator style={{ marginBottom: 20 }} />
          );
        }}
      />
