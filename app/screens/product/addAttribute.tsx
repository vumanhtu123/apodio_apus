...
export const AddAttribute: FC = observer(
    function AddAttribute(props) {
        ...
        const getListDataAttribute = async () => {
            try {
                ...
                if (response && response.kind === 'ok') {
                    ...
                    console.log('getListDataAttribute---------------------', JSON.stringify(response.response.data))
        ...
        const handleSelect = (items: any) => {
            ...
            const newArr3 = newArr2.flatMap((items: any) => items.filter((item: any) => item !== undefined))
        ...
        const onConfirm = () => {
            if (selectedItems.length === 0) {
                ...
                if (editScreen?.editScreen === true) {
                    navigation.navigate('ProductEditScreen' as never, { check: true, attributeArr: selectedItems, dropdownSelected: dropdownSelected })
                }
                else { navigation.navigate('ProductCreateScreen' as never, { check: true, attributeArr: selectedItems, dropdownSelected: dropdownSelected, resetData: false }) }
            }
        }
                ...
                <View style={[styles.viewBody, { top: scaleHeight(52) + scaleHeight(paddingTop), }]}>
                    ...
                    <ScrollView>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Images.icon_add />
                            <Text text="Tạo nhóm thuộc tính mới" style={{
