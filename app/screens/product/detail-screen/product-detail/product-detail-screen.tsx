...
import ProductAttributeDetails from "../product-detail/render/attribute-detail";
import ProductClassificationDetail from "../product-detail/render/classification-list-detail";
import ProductImageGallery from "../product-detail/render/product-detail-images";
import ProductDetailsSection from "../product-detail/render/product-detail-render";
import ProductWeightDetails from "../product-detail/render/weight-detail";
