...
import { Dimensions, FlatList, ScrollView, TextInput, TextStyle, TouchableOpacity, View, ViewStyle } from 'react-native';
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={{
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value, onBlur } }) => (
                                            <TextInput
                                                ...
                                                placeholder="nhap ma quy doi"
                                                style={{
                                                    width: (Dimensions.get('screen').width - scaleWidth(64)) * 0.4,
                                    ...
                                    <TouchableOpacity onPress={() => setShowModal(true)}
                                        style={{
                                            width: (Dimensions.get('screen').width - scaleWidth(64)) * 0.25,
                                            borderBottomWidth: 1,
                                ...
                                {originalUnit.label && unit && conversionWatch[index].ratio ? <Text text={'1 ' + originalUnit.label + ' = ' + conversionWatch[index].ratio + ' ' + unit} /> : null}
                            </View>
