...
import { Dimensions, FlatList, Modal, StyleSheet, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                            ...
                            <Text tx='demoPodcastListScreen.dialogOtp' style={styles.modalClose} onPress={() => setIsVisible(false)}/>
                        </View>
