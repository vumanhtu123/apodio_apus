...
export interface Root {
  ...
  export type OrderListAddressResult = { kind: "ok", response: Response1 } | { kind: "bad-data", response: Response1 };
  ...
  export type OrderDistrictResult = { kind: "ok", response: Response2 } | { kind: "bad-data", response: Response2 };
  ...
  export type OrderWardResult = { kind: "ok", response: Response3 } | { kind: "bad-data", response: Response3 };