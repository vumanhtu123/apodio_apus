...
export const ApiEndpoint = {
  ...
  HISTORY: "/history",
  LIST_CATEGORY: "/api/v3/internal/product-category/list",
  DETAIL_UNIT_GROUP: "/api/v2/unit-group",
  LIST_UNIT: "/api/v2/unit/list",
  LIST_UNIT_GROUP: "/api/v2/unit-group/list",
  DELETE_CATEGORY: "/api/v3/internal/product-category",
  CREATE_CATEGORY: "/api/v3/internal/product-category",
  UPDATE_CATEGORY: "/api/v3/internal/product-category",
