export const ApiEndpoint = {
  ...
  HISTORY: "/history",
  LIST_CATEGORY: "/api/v1/goods/product-category/list",
  DETAIL_UNIT_GROUP: "/api/v1/mobile-unit-group", 
  LIST_UNIT: "/api/v1/unit/list",
  LIST_UNIT_GROUP: "/api/v1/unit-group/list",
  DELETE_CATEGORY: "/api/v1/goods/mobile-product-category",
  CREATE_CATEGORY: "/api/v1/goods/mobile-product-category",
  UPDATE_CATEGORY: "/api/v1/goods/mobile-product-category",
  ...
  CREATE_ATTRIBUTE_GROUP: "/api/v1/product-attribute-category",
