const fr = {
  ...
  order: {
    ...
    customer_needPaid: "Khách cần trả",
  ...
  inforMerchant: {
    ...
    setTingShop: "Settings store",
    setLanguage: "Select language",
    setQR: "Mã QR của tôi",
    userManual: "HD Use",
    InforMerChant: "Thông tin merchant",
    btnInfor: "Informations",
    btnSecutityAcc: "Security account",
    btnChangePassword: "Change password",
    btnIntroduct: "Introduct",
    btnFeedback: "Feedback",
    btnSettingBell: "Settings notification",
  ...
  productScreen: {
    ...
    cannotPrepayMoreThanTheOrderValue:
      "Không thể trả trước quá giá trị đơn hàng",
    ...
    searchNameCategories: "Tìm tên danh mục",
    uploadImage: " Tải ảnh lên",
    camera: "Chụp ảnh",
    enterCount: "Nhập SL",
    enterCountMinimum: "Nhập số lượng tối thiểu",
    enterPrice: "Nhập giá",
    enterProduct: "Nhập giá sản phẩm",
    sort: "Sắp xếp",
    cancelFilter: "Hủy",
    enterValue: "Nhập giá trị",
    selectProductFirst: "Chọn sản phẩm đưa lên đầu",
    enterGroup: "Nhập tên nhóm",
    createDVT: "Tạo ĐVT",
    conversionRate1: "Tỉ lệ quy đổi",
    enterConversionCode1: "Nhập mã quy đổi",
    selectDVT: "Chọn ĐVT",
    pleaseEnterData: "Vui lòng nhập dữ liệu",
    updateAttribute: "Sửa thuộc tính",
    filter1: "Bộ lọc",
    listCategories: "Danh mục sản phẩm",
    detailsProduct: "Chi tiết sản phẩm",
    infoAll: "Thông tin chung",
  ...
  detailScreen: {
    ...
    nameCodeProduct: "Tên biến thể sản phẩm ",
    miniumPurchase: "Mua tối thiểu",
    capitalPrice: "Giá vốn",
    listedPrice: "Giá niêm yết",
    category: "Danh mục",
    propertyDetails: "Xem chi tiết thuộc tính",
    property: " Thuộc tính",
    value: "Giá trị",
  ...
  wareHouse: {
    ...
    enterCodeWareHouse: "Nhập mã kho",
    nameWareHouse: "Tên kho",
    enterWareHouse: "Nhập tên kho",
    address: "Địa chỉ",
    enterAddress: "Nhập địa chỉ",
    storageConditions: "Điều kiện bảo quản",
    configInfoMore: "Cấu hình thông tin bổ sung",
    defaultWareHouse: "Đặt làm kho mặc định",
    Longitude: "Kinh độ",
    enterLongitude: "Nhập kinh độ",
    enterLatitude: "Nhập vĩ độ",
    Latitude: "Vĩ độ",
    standardStorageTemperature: "Nhiệt độ bảo quản tiêu chuẩn",
    enterTemperature: "Nhập nhiệt độ",
    minimumStorageTemperature: "Nhiệt độ bảo quản tối thiểu",
    standardHumidity: "Độ ẩm tiêu chuẩn",
    enterHumidity: "Nhập độ ẩm",
    length: "Chiều dài",
    enterLength: "Nhập chiều dài",
    width: "Chiều rộng",
    enterWidth: "Nhập chiều rộng",
    height: "Chiều cao",
    enterHeight: "Nhập chiều cao",
    foundationLoad: "Tải trọng nền",
