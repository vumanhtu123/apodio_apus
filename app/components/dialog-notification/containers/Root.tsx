...
import {Loading, IConfigLoading} from './Loading'

import { Color, IColors } from '../service';
import { StyleSheet } from 'react-native';

type IProps = {
  loadingConfig?: Pick<IConfigLoading, 'textStyle'>;
...
export const Root: React.FunctionComponent<IProps> = ({ theme, colors, children, dialogConfig, toastConfig, loadingConfig }) => {
    ...
    return (
      <SafeAreaProvider>
        <View style={styles.content}>
          <React.Fragment>
            <Loading ref={Loading.instance} isDark={isDark} config={loadingConfig}/>
