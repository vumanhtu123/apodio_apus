...
const BTNLEFT: ViewStyle = {
  width: scaleWidth(30),
  height: scaleHeight(30),
  alignItems: "center",
};
const BTNRIGHT: ViewStyle = {
  width: scaleWidth(25),
...
export function Header(props: HeaderProps) {
  ...
  const searchPlaceholder =
    searchText || (searchTx && translate(searchTx)) || "";
  ...
  return (
    <View>
      <LinearGradient
        ...
        style={{ height: useSafeAreaInsets().top }}></LinearGradient>
      <LinearGradient
        start={{ x: 0, y: 1 }}
        end={{ x: 1, y: 1 }}
        colors={[colors.palette.navyBlue, colors.palette.malibu]}
        ...
        <View
          style={[RIGHT, { flexDirection: "row", justifyContent: "flex-end" }]}>
          {rightText1 ? (
            <Button
              preset="link"
          ...
          {RightIconAndTextBelow && (
            <Button
              ...
              <RightIconAndTextBelow
                width={widthRightIcon}
                height={heightRightIcon}
              />
              {textBelowIconRight && (
                <Text
                  text={textBelowIconRight}
        ...
        headerInput && (
          <LinearGradient
            ...
            style={{
              ...
              flexDirection: "row",
              alignItems: "center",
              justifyContent: RightIconTextInput ? "space-evenly" : "center",
            }}>
            <View
              style={{
                position: "absolute",
